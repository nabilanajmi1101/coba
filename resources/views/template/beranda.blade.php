                    ...
                    <div class="container-fluid">
                        <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                            <div class="collapse navbar-collapse" id="topnav-menu-content">
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link" href="/halamanguru">
...
@yield('main-content')
            ...
            {{-- <section class="progres" id="progres">
                <div class="progres-container">
                    <div class="p-box">
                        <div class="bulat1">
                            <span class="p-value1">0%</span>
                        </div>
                        <span style="color: #2A5D66; font-size:20px; font-weight:bold" class="text">Konsep Pythagoras</span>
                    </div>
                    <div class="p-box">
                        <div class="bulat2">
                            <span class="p-value2">0%</span>
                        </div>
                        <span style="color: #2A5D66; font-size:20px; font-weight:bold" class="text">Teorema Pythagoras</span>
                    </div>
                    <div class="p-box">
                        <div class="bulat3">
                            <span class="p-value3">0%</span>
                        </div>
                        <span style="color: #2A5D66; font-size:20px; font-weight:bold" class="text">Tripel Pythagoras</span>
                    </div>
                </div>
            </section> --}}
